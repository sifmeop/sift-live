...
import { data, Meta, Scripts, ScrollRestoration, useLoaderData } from 'react-router'
...
export function Layout({ children }: { children: React.ReactNode } & Route.ComponentProps) {
...
export const meta: Route.MetaFunction = ({ params }) => {
  ...
  return [{ title: content.title }, { content: content.description, name: 'description' }]
}
...
import { getHTMLTextDir, getLocaleName, getLocalizedUrl, getPathWithoutLocale } from 'intlayer'
