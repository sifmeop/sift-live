...
import { BrowserRouter, Routes, Route, Navigate, useLocation } from 'react-router-dom' // Router components for managing navigation
    ...
    <Routes>
...

      {
        ...
        !middleware.prefixDefault && (
          <Route
            path="*"
            element={<AppLocalized locale={defaultLocale}>{children}</AppLocalized>} // Wraps children with locale management
          />
        )
      }
    </Routes>
